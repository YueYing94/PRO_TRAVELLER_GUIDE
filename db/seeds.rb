...
wine_tasting.image.attach(io: file, filename: "Wine.png", content_type: "image/png")
...
hiking.image.attach(io: file, filename: "Hiking.png", content_type: "image/png")
hiking.user = yue
hiking.save!
...
surfing.image.attach(io: file, filename: "Surfing.png", content_type: "image/png")
surfing.user = jose
surfing.save!
...
sight_seeing.image.attach(io: file, filename: "Sighseeing.png", content_type: "image/png")
...
mountain_climbing.image.attach(io: file, filename: "Mountainclimb.png", content_type: "image/png")
